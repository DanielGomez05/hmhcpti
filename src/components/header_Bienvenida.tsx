...
export default function HeaderBienvenida() {
  ...
  useEffect(() => {
    ...
    setNombreUsuario(nombre.split(" ")[0])

    const actualizarHora = () => {
      const hoy = new Date()
      const fecha = hoy.toLocaleDateString("es-MX", { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric' })
      ...
      <div className="flex justify-between items-center px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <span className="font-century font-light text-xs leading-4 text-left text-[#9FB816] hidden sm:block">
            Herramienta para medir la huella de carbono de los<br />Proyectos de TI
          </span>
        </div>
        ...
        <div className="flex items-center space-x-4 text-sm">
          ...
          <button onClick={toggleModoOscuro}>
            <Image src={modoOscuro ? "/images/Luna.png" : "/images/Sol.png"} alt="Modo Oscuro" width={22} height={22} />
          </button>
