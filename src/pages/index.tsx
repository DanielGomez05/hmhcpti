...
export default function Home() {
  return (
    <div className="font-century bg-white min-h-screen flex flex-col">
      ...
      <main
        id="app"
        className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 flex-grow"
      >
          ...
          <div className="lg:w-1/2 space-y-6 md:space-y-10">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl leading-snug font-semibold">
              <span className="text-black block">
                ...
                <br />
                entrega información valiosa y toma medidas con
              </span>
              <span className="text-lime-500 block font-bold">HMHCPTI</span>
            </h2>

            <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 leading-relaxed">
              Nuestra herramienta te ayuda a medir y monitorear la huella de carbono
              de tus proyectos de TI, impulsando tu compromiso con la sostenibilidad.
            </p>
